...
// Do not edit manually — run: go run scripts/gen_terraform/main.go schema/users-schema.yaml <output.go>

package tfprovider

func init() {
	RegisterResourceGroup(UsersResourceGroup)
}

// UsersResourceGroup contains the Terraform resource definition for the "users" resource group.
var UsersResourceGroup = ResourceGroup{
	TypeName: `users`,
	...
	Ops: MapCRUDOps(`users`, []OperationDef{
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-users/#api-user-get`,
		},
		{
...
confirmed and unconfirmed.`,
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-users/#api-user-emails-get`,
		},
		{
...
whether it is the user's primary address or not.`,
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-users/#api-user-emails-email-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-users/#api-users-selected-user-get`,
		},
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `subkeys`, Type: `string`, Desc: `subkeys (JSON array)`},
			},
			HasBody:   false,
			Paginated: true,
			Scopes: []string{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-gpg/#api-users-selected-user-gpg-keys-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-gpg/#api-users-selected-user-gpg-keys-post`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-gpg/#api-users-selected-user-gpg-keys-fingerprint-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-gpg/#api-users-selected-user-gpg-keys-fingerprint-delete`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-ssh/#api-users-selected-user-ssh-keys-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-ssh/#api-users-selected-user-ssh-keys-post`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-ssh/#api-users-selected-user-ssh-keys-key-id-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-ssh/#api-users-selected-user-ssh-keys-key-id-put`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-ssh/#api-users-selected-user-ssh-keys-key-id-delete`,
		},
	}),
	AllOps: []OperationDef{
		{
