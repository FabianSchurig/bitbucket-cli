	...
	Ops: MapCRUDOps(`hooks`, []OperationDef{
		{
			...
			ResponseFields: []BodyFieldDef{
				{Path: `repository.events.href`, Type: `string`, Desc: `repository.events.href`},
				{Path: `repository.events.name`, Type: `string`, Desc: `repository.events.name`},
				{Path: `workspace.events.href`, Type: `string`, Desc: `workspace.events.href`},
				{Path: `workspace.events.name`, Type: `string`, Desc: `workspace.events.name`},
			},
			HasBody:   false,
			Paginated: false,
