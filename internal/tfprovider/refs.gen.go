...
// Do not edit manually — run: go run scripts/gen_terraform/main.go schema/refs-schema.yaml <output.go>

package tfprovider

func init() {
	RegisterResourceGroup(RefsResourceGroup)
}

// RefsResourceGroup contains the Terraform resource definition for the "refs" resource group.
var RefsResourceGroup = ResourceGroup{
	TypeName: `refs`,
...
Bitbucket will apply natural sorting and interpret numerical values as numbers instead of strings.`,
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `target.date`, Type: `string`, Desc: `target.date`},
				{Path: `target.hash`, Type: `string`, Desc: `target.hash`},
				{Path: `target.message`, Type: `string`, Desc: `target.message`},
				{Path: `target.parents`, Type: `string`, Desc: `parents (JSON array)`},
				{Path: `target.participants`, Type: `string`, Desc: `participants`, IsArray: true, ItemFields: []BodyFieldDef{
				...
				{Path: `target.summary.markup`, Type: `string`, Desc: `The type of markup language the raw content is to be interpreted in. [markdown, creole, plaintext]`},
				{Path: `target.summary.raw`, Type: `string`, Desc: `The text as it was typed by a user.`},
