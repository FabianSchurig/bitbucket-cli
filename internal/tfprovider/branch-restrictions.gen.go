...
repository.`,
			...
			ResponseFields: []BodyFieldDef{
				{Path: `branch_match_kind`, Type: `string`, Desc: "Indicates how the restriction is matched against a branch. The default is `glob`. [branching_model, glob]", Required: true},
				...
				{Path: `groups`, Type: `string`, Desc: `groups`, IsArray: true, ItemFields: []BodyFieldDef{
...
characters and can therefore be slightly different than the name`},
				...
				{Path: `id`, Type: `int`, Desc: `The branch restriction status' id.`},
				...
				{Path: `pattern`, Type: `string`, Desc: "Apply the restriction to branches that match this pattern. Active when `branch_match_kind` is `glob`. Will be empty when `branch_match_kind` is `branching_model`.", Required: true},
				{Path: `pipelines_source_branches`, Type: `string`, Desc: `List of source branch names allowed to push back to the restricted branch. Used in conjunction with pipeline-based restrictions.`, IsArray: true},
				{Path: `users`, Type: `string`, Desc: `users`, IsArray: true, ItemFields: []BodyFieldDef{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-branch-restrictions/#api-repositories-workspace-repo-slug-branch-restrictions-get`,
		},
		{
...
characters and can therefore be slightly different than the name`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-branch-restrictions/#api-repositories-workspace-repo-slug-branch-restrictions-post`,
		},
		{
...
characters and can therefore be slightly different than the name`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-branch-restrictions/#api-repositories-workspace-repo-slug-branch-restrictions-id-get`,
		},
		{
...
characters and can therefore be slightly different than the name`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-branch-restrictions/#api-repositories-workspace-repo-slug-branch-restrictions-id-put`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-branch-restrictions/#api-repositories-workspace-repo-slug-branch-restrictions-id-delete`,
		},
	}),
	AllOps: []OperationDef{
		{
