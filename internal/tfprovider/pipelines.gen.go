...
`,
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `configuration_sources`, Type: `string`, Desc: `An ordered list of sources of the pipeline configuration (JSON array)`},
				...
				{Path: `variables`, Type: `string`, Desc: `The variables for the pipeline. (JSON array)`},
			},
			HasBody:   false,
			Paginated: true,
			Scopes: []string{
		...
		},
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `script_commands`, Type: `string`, Desc: `The list of build commands. These commands are executed in the build container. (JSON array)`},
				{Path: `setup_commands`, Type: `string`, Desc: `The list of commands that are executed as part of the setup phase of the build. These commands are executed outside the build container. (JSON array)`},
