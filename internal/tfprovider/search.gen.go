	...
	Ops: MapCRUDOps(`search`, []OperationDef{
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `content_matches`, Type: `string`, Desc: `content_matches (JSON array)`},
				{Path: `file.attributes`, Type: `string`, Desc: `[link, executable, subrepository, binary, lfs]`},
				{Path: `file.escaped_path`, Type: `string`, Desc: `The escaped version of the path as it appears in a diff. If the path does not require escaping this will be the same as path.`},
				{Path: `file.path`, Type: `string`, Desc: `The path in the repository`},
				{Path: `file.type`, Type: `string`, Desc: `file.type`},
				{Path: `path_matches`, Type: `string`, Desc: `path_matches (JSON array)`},
