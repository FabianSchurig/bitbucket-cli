...
request.`,
		...
		},
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `pullrequest.comment_count`, Type: `int`, Desc: `The number of comments for a specific pull request.`},
				{Path: `pullrequest.created_on`, Type: `string`, Desc: `The ISO8601 timestamp the request was created.`},
				...
				{Path: `pullrequest.merge_commit.hash`, Type: `string`, Desc: `pullrequest.merge_commit.hash`},
				{Path: `pullrequest.participants`, Type: `string`, Desc: `        The list of users that are collaborating on this pull request.
        Collaborators are user that:
        ...
        * are not explicit reviewers, but have approved the pull request
        ...
        `, IsArray: true, ItemFields: []BodyFieldDef{
				...
				{Path: `pullrequest.queued`, Type: `bool`, Desc: `A boolean flag indicating whether the pull request is queued`},
				...
				{Path: `pullrequest.reviewers`, Type: `string`, Desc: "The list of users that were added as reviewers on this pull request when it was created. For performance reasons, the API only includes this list on a pull request's `self` URL.", IsArray: true, ItemFields: []BodyFieldDef{
					{Path: `uuid`, Type: `string`, Desc: `uuid`},
					{Path: `created_on`, Type: `string`, Desc: `created_on`},
					{Path: `display_name`, Type: `string`, Desc: `display_name`},
				}},
				{Path: `pullrequest.state`, Type: `string`, Desc: `The pull request's current status. [OPEN, DRAFT, QUEUED, MERGED, DECLINED, SUPERSEDED]`},
				{Path: `pullrequest.summary.markup`, Type: `string`, Desc: `The type of markup language the raw content is to be interpreted in. [markdown, creole, plaintext]`},
				{Path: `pullrequest.summary.raw`, Type: `string`, Desc: `The text as it was typed by a user.`},
				{Path: `pullrequest.task_count`, Type: `int`, Desc: `The number of open tasks for a specific pull request.`},
				{Path: `pullrequest.title`, Type: `string`, Desc: `Title of the pull request.`},
				{Path: `pullrequest.updated_on`, Type: `string`, Desc: `The ISO8601 timestamp the request was last updated.`},
				{Path: `resolution.created_on`, Type: `string`, Desc: `The ISO8601 timestamp the resolution was created.`},
				{Path: `resolution.type`, Type: `string`, Desc: `resolution.type`},
...
See [filtering and sorting](/cloud/bitbucket/rest/intro/#filtering) for more details.`,
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `comment.created_on`, Type: `string`, Desc: `comment.created_on`},
				{Path: `comment.deleted`, Type: `bool`, Desc: `comment.deleted`},
				{Path: `comment.id`, Type: `int`, Desc: `comment.id`},
				...
				{Path: `comment.updated_on`, Type: `string`, Desc: `comment.updated_on`},
				{Path: `content.markup`, Type: `string`, Desc: `The type of markup language the raw content is to be interpreted in. [markdown, creole, plaintext]`},
				{Path: `content.raw`, Type: `string`, Desc: `The text as it was typed by a user.`},
				{Path: `created_on`, Type: `string`, Desc: `created_on`},
				...
				{Path: `id`, Type: `int`, Desc: `id`},
				{Path: `pending`, Type: `bool`, Desc: `pending`},
				{Path: `resolved_by.created_on`, Type: `string`, Desc: `resolved_by.created_on`},
				{Path: `resolved_by.display_name`, Type: `string`, Desc: `resolved_by.display_name`},
				{Path: `resolved_by.uuid`, Type: `string`, Desc: `resolved_by.uuid`},
