...
As a result, the link should not be persisted, stored, or shared.`,
		...
		},
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `created_on`, Type: `string`, Desc: `created_on`},
				{Path: `issue.component.id`, Type: `int`, Desc: `issue.component.id`},
				...
				{Path: `issue.milestone.id`, Type: `int`, Desc: `issue.milestone.id`},
				...
				{Path: `issue.version.id`, Type: `int`, Desc: `issue.version.id`},
