...
// Do not edit manually — run: go run scripts/gen_terraform/main.go schema/workspaces-schema.yaml <output.go>

package tfprovider

func init() {
	RegisterResourceGroup(WorkspacesResourceGroup)
}

// WorkspacesResourceGroup contains the Terraform resource definition for the "workspaces" resource group.
var WorkspacesResourceGroup = ResourceGroup{
	TypeName: `workspaces`,
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-user-permissions-workspaces-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-user-workspaces-get`,
		},
		{
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-user-workspaces-workspace-permission-get`,
		},
		{
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-get`,
		},
		{
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-get`,
		},
		{
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-members-get`,
		},
		{
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-members-member-get`,
		},
		{
...
private to the members and consequently only visible to members.`},
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-permissions-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-permissions-repositories-get`,
		},
		{
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-permissions-repositories-repo-slug-get`,
		},
		{
...
Note that private projects cannot contain public repositories.`},
		...
		},
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `destination.branch.merge_strategies`, Type: `string`, Desc: `Available merge strategies, when this endpoint is the destination of the pull request. (JSON array)`},
        ...
        * are not explicit reviewers, but have approved the pull request
        ...
        id.
         (JSON array)`},
				...
				{Path: `reviewers`, Type: `string`, Desc: "The list of users that were added as reviewers on this pull request when it was created. For performance reasons, the API only includes this list on a pull request's `self` URL. (JSON array)"},
				...
				{Path: `source.branch.merge_strategies`, Type: `string`, Desc: `Available merge strategies, when this endpoint is the destination of the pull request. (JSON array)`},
...
During a key rotation period, two keys may be returned.`,
			...
			DocURL: `https://developer.atlassian.com/cloud/bitbucket/rest/api-group-workspaces/#api-workspaces-workspace-settings-gpg-public-key-get`,
		},
	}),
	AllOps: []OperationDef{
		{
