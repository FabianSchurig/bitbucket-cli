...
// Do not edit manually — run: go run scripts/gen_terraform/main.go schema/properties-schema.yaml <output.go>

package tfprovider

func init() {
	RegisterResourceGroup(PropertiesResourceGroup)
}

// PropertiesResourceGroup contains the Terraform resource definition for the "properties" resource group.
var PropertiesResourceGroup = ResourceGroup{
	TypeName: `properties`,
