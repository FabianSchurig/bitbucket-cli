...
`},
				...
				{Path: `mainbranch.merge_strategies`, Type: `string`, Desc: `Available merge strategies for pull requests targeting this branch. (JSON array)`},
...
Note that private projects cannot contain public repositories.`},
		...
		},
		{
			...
			ResponseFields: []BodyFieldDef{
				...
				{Path: `events`, Type: `string`, Desc: `The events this webhook is subscribed to. (JSON array)`},
