...
// TestAccRealAPI_ResourceSSHKeys_CRUD creates a repository, sets an SSH key pair
// for pipelines, and verifies the lifecycle.
func TestAccRealAPI_ResourceSSHKeys_CRUD(t *testing.T) {
	workspace := skipIfNoRealAPI(t)
