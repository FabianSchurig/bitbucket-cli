...
// Do not edit manually — run: go run scripts/gen_mcptools/main.go schema/branching-model-schema.yaml <output.go>
...
`,
	Operations: []OperationDef{
		...
		},
		{
			...
			BodyFields: []BodyFieldDef{
				{Path: `branch_types`, Type: `string`, Desc: `branch_types`},
