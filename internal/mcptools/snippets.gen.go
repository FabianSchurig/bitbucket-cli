...
// Do not edit manually — run: go run scripts/gen_mcptools/main.go schema/snippets-schema.yaml <output.go>

package mcptools

func init() {
	AllToolGroups = append(AllToolGroups, SnippetsToolGroup)
}
	...
	Operations: []OperationDef{
		...
		},
		{
			...
			BodyFields: []BodyFieldDef{
				...
				{Path: `snippet.id`, Type: `int`, Desc: `id`},
			},
			HasBody:   true,
			Paginated: false,
		},
