...
// Do not edit manually — run: go run scripts/gen_mcptools/main.go schema/branch-restrictions-schema.yaml <output.go>
...
repository.`,
		...
		},
		{
			...
			BodyFields: []BodyFieldDef{
				...
				{Path: `groups`, Type: `string`, Desc: `groups`},
				...
				{Path: `pipelines_source_branches`, Type: `string`, Desc: `List of source branch names allowed to push back to the restricted branch. Used in conjunction with pipeline-based restrictions.`},
				{Path: `users`, Type: `string`, Desc: `users`},
