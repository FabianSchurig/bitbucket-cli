...
func init() {
	AllToolGroups = append(AllToolGroups, RefsToolGroup)
}
...
Bitbucket will apply natural sorting and interpret numerical values as numbers instead of strings.`,
		...
		},
		{
			...
			BodyFields: []BodyFieldDef{
				...
				{Path: `target.hash`, Type: `string`, Desc: `hash`},
				{Path: `target.date`, Type: `string`, Desc: `date`},
				{Path: `target.message`, Type: `string`, Desc: `message`},
