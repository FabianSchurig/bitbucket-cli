...
`)
	...
	cmd.Flags().StringVar(&bodyMainbranchMergeStrategies, "mainbranch-merge-strategies", "", `Available merge strategies for pull requests targeting this branch. (JSON array)`)
