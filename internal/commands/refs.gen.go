...
// Do not edit manually — run: go run scripts/gen_commands/main.go schema/refs-schema.yaml <output.go>
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if body == "" {
				...
				if bodyTargetParents != "" {
					handlers.SetNested(bodyObj, "target.parents", bodyTargetParents)
				}
				if bodyType != "" {
