...
func newPRCreateAPullRequestCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyState, "state", "", `The pull request's current status. [OPEN, MERGED, DECLINED, SUPERSEDED]`)
...
Returns the newly created pull request comment.`,
	...
	cmd.Flags().StringVar(&bodyPullrequestState, "pullrequest-state", "", `The pull request's current status. [OPEN, MERGED, DECLINED, SUPERSEDED]`)
