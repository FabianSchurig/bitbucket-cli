...
- `development_branch_merge_strategies` (String) Available merge strategies for pull requests targeting this branch. (JSON array)
...
- `production_branch_merge_strategies` (String) Available merge strategies for pull requests targeting this branch. (JSON array)
