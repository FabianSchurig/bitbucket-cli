...
```hcl
import {
  to = bitbucket_project_branch_restrictions_by_branch_type.example
...
```shell
terraform import bitbucket_project_branch_restrictions_by_branch_type.example "my-workspace/PROJ"
```
