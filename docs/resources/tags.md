...
- `target_date` (String) target.date (also computed from API response)
- `target_hash` (String) target.hash (also computed from API response)
- `target_message` (String) target.message (also computed from API response)
- `target_parents` (String) parents (JSON array) (also computed from API response)
